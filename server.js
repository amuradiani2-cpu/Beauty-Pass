...
async function send2FACode(user) {
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; background-color: #f4f4f4f4; padding: 20px;">
        <div style="max-width: 600px; margin: auto; background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          ...
          <p style="font-size: 16px; color: #333;">Здравствуйте, ${user.firstName || user.login}!</p>
          <p style="font-size: 16px; color: #333;">Ваш код подтверждения для входа:</p>
          ...
          <p style="font-size: 14px; color: #888;">Код действителен 2 минуты.</p>
          <p style="font-size: 14px; color: #888;">Если вы не запрашивали код, проигнорируйте это письмо.</p>
        </div>
      </div>
    `,
  };
